...
//
//@Slf4j
//public final class AgentPromptAdvisor implements BaseChatMemoryAdvisor {
...
//
//    private AgentPromptChatMemoryAdvisor(ChatMemory chatMemory, String defaultConversationId, int order, Scheduler scheduler,
...
//         * @return the advisor
//         */
//        public AgentPromptChatMemoryAdvisor build() {
//            return new AgentPromptChatMemoryAdvisor(this.chatMemory, this.conversationId, this.order, this.scheduler,
